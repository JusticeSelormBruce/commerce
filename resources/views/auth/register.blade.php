                ...
                <div class="card-body">
                    <form method="POST" action="/admin/register-user">
                      ...
                      <div class="alert alert-primary" role="alert">
                        Multifactor Authentication Details Face 1
                      </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="alert alert-success" role="alert">
                                Multifactor Authentication Details Face 2
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control @error('email1') is-invalid @enderror" name="email1" value="{{ old('email1') }}" required autocomplete="email1">
